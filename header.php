...
echo <<<_MAIN
    <title>Yeshi's Nest: $userstr</title>
  </head>
  <body>
    <div data-role='page'>
      <div data-role='header'>
        <div id='logo' class='center'>Y<img id='yeshi' src='robin.gif'>shi's Nest</div>
        <div class='username' style="margin-top: -38px;">$userstr</div>
      </div>
